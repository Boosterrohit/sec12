        ...
        <div className="container">
          <div className="row sliding flex justify-center items-center">
              ...
              <Carousel>
                <Carousel.Item>
                  <img
                    ...
                    src="https://rhythm.bestlooker.pro/rhythm-original/images/promo-3.png"
                    alt="First slide"
                  />
                </Carousel.Item>
                <Carousel.Item>
                  <img
                    ...
                    src="https://rhythm.bestlooker.pro/rhythm-original/images/portfolio/full-project-2.jpg"
                    alt="Second slide"
                  />
                </Carousel.Item>
              </Carousel>
            ...
            <div className="col-lg-5 col-md-5 col-12">
              <h3 className="font-[dosis] mb-7">AWESOME TEMPLATE</h3>
              <p className="mb-7">
